...
<main class="min-vh-60">
    <section class="container py-4">
        <div class="card p-4">
            ...
            <p>Cloud mining lets you rent mining power instead of owning hardware. It’s easier but riskier due to reliance on third-party vendors. Stick to reputable providers such as BRIDGEX INV..</p>
        </div>
    </section>
</main>
