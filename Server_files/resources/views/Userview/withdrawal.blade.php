                ...
                <div class="card card-h-100">
                   ...
                   <div class="card-body">
                      <div class="row align-items-center">
                         <div class="col-6">
                            <span class="text-muted mb-3 lh-1 d-block text-truncate">My Balance</span>
                            <h4 class="mb-3">
                   ...
                   <div class="card-body">
                      <div class="row align-items-center">
                         <div class="col-6">
                            ...
                            <h4 class="mb-3">
                               $<span>{{ number_format(Auth::user()->trading_balance) }}</span>
                            </h4>
                         </div>
                         <div class="col-6">
                      ...
                      <div class="text-nowrap"> 
                         <button type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop2" class="btn btn-soft-primary waves-effect waves-light btn-rounded " ><i class="bx bx-transfer-alt label-icon"></i> Withdraw Funds to Balance</button>
                         <br>
                         <div class="modal fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                               <div class="modal-content">
                                  <form action="{{ route('withdraw.to.balance') }}" method="post">
                                    @csrf
                                     <div class="modal-header">
                                        <h5 class="modal-title" id="staticBackdropLabel">Wtihdraw Funds to Balance</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                     </div>
                                     <div class="modal-body">
                                        <div class="col-lg-12">
