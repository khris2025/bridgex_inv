                                       ...
                                       <div>
                                          <form action="{{ route('modify_profile', ['id' => $user->id]) }}" method="post">
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                   <div class="mb-3">
                                                      <label class="form-label text-success" for="formrow-email-input">Trading Balance</label>
                                                      <input type="number" class="form-control" id="formrow-email-input" name="tradingBalance" value="{{ $user->trading_balance }}">
                                                   </div>
                                                </div>
                                                {{-- <div class="col-md-6">
                                                   <div class="mb-3">
