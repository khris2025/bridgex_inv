...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/transactions', [TradeController::class, 'transactions'])->name('Transactions');

    Route::post('tradestore', [TradeController::class, 'store'])->name('trade.store');
    ...
    Route::post('/withdraw-to-balance', [Userwithdrawal::class, 'withdrawToBalance'])->name('withdraw.to.balance');
    ...
    Route::middleware(['auth', 'admin'])->group(function () {
        ...
        Route::get('/manage_trades', [admin_pagecontroller::class, 'manage_trades'])->name('manage.trades');
        ...
        //End Trades
        Route::get('/end_trade/{id}', [admin_action::class, 'end_ongoingtrade'])->name('end_trade');
        Route::post('/trades/{id}/update-profit', [admin_action::class, 'updatetradeProfit'])->name('update_trade_profit');
        ...
        Route::delete('/copy-traders/{id}', [admin_action::class, 'destroy_trader'])->name('delete_trader');
