...
class admin_pagecontroller extends Controller
{
    ...
    {
        $all_traders = CopyTrader::orderByDesc('created_at')->get();
        return view('Adminview.addtraders', compact('all_traders'));
    }
    ...
    public function manage_trades(){
        $allTrades = Trade::where('status', 'Active')->orderBy('created_at', 'desc')->get();
        return view('Adminview.manageTrades', compact('allTrades'));
    }
}
