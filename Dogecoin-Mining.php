...
<main class="min-vh-60">
    <section class="container py-4">
        <div class="card shadow-sm p-4">
            ...
            <div class="mb-3">
                <p>Cloud mining lets a third party do the technical work for a fee. Check costs vs. returns before committing. Some vendors offer free trials (e.g., BRIDGEX INV.).</p>
            </div>
